...
class BaseRetrieverTester:
    ...
    def __init__(self, batch_size, batch_num, dataset=None, log_level=logging.INFO):
        """
...
def main():
    ...
    parser.add_argument(
        "--batch-size", type=int, default=10, help="Maximum number of rows to test"
    )
    parser.add_argument(
        "--batch-num", type=int, required=True, help="Query count to filter the dataset"
    )
